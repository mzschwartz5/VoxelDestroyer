...
/**
 * Render override responsible for special voxel-shape painting passes. Also used to get access to the viewport's depth buffer, so we can interactively
 * drag voxel shapes in 3D space based on mouse position.
 * 
